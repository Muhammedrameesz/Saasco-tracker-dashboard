  ...
  return (
    <>
      {startLocation && destinationLocation && (
        <section className="mt-10 md:mt-16 flex items-center justify-center max-w-7xl mx-auto px-4">
          <div className="  relative min-h-[150px] bg-gradient-to-r from-green-300 via-emerald-400 to-lime-300 p-[2px] rounded-xl shadow-2xl w-full max-w-md">
