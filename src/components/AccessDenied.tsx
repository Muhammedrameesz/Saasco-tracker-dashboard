...
export default function AccessDenied() {
  return (
    <div className="min-h-screen w-full font-Lexend flex items-center justify-center bg-[#fafafa] selection:bg-brand-50 antialiased">
      {/* Dynamic Background Elements */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-[10%] left-[15%] w-[400px] h-[400px] bg-brand-100/40 rounded-full blur-[120px]" />
      ...
      <div className="relative z-10 w-full max-w-lg px-6">
        <div className="flex flex-col items-center">
          ...
          <div className="relative mb-12 group">
            ...
            <div className="absolute inset-0 bg-brand-500/15 rounded-[2.5rem] blur-2xl group-hover:bg-brand-500/25 transition-all duration-700 scale-90 group-hover:scale-110" />
            ...
            <div className="relative bg-white border border-slate-200/80 p-1 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden">
              <div className="bg-slate-50/50 rounded-[2.2rem] p-8 relative overflow-hidden">
                ...
                <div className="absolute inset-0 w-full h-1/2 bg-gradient-to-b from-brand-500/5 to-transparent -translate-y-full animate-[scan_3s_ease-in-out_infinite] pointer-events-none" />

                <div className="relative flex items-center justify-center">
                  {/* The "Shield" Layer */}
                  <ShieldAlert
                    className="absolute w-20 h-20 text-brand-50/80 -rotate-12 transition-transform duration-500 group-hover:rotate-0"
                    strokeWidth={1}
                  />
          ...
          <div className="text-center space-y-4 mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 border border-brand-100 text-[11px] font-bold tracking-widest uppercase text-brand-600 mb-2">
          ...
          <div className="w-full bg-white/70 backdrop-blur-xl border border-white rounded-3xl p-6 mb-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-slate-200/50">
            <div className="flex items-start gap-4">
              <div className="h-10 w-1 bg-brand-500 rounded-full mt-1" />
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  ...
                  <span className="text-brand-600 font-medium italic">
